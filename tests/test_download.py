...
def test_get_static_download_size() -> None:
	...
	assert get_static_download_size('https://hf-mirror.com/facefusion/models-3.0.0/resolve/main/fairface.onnx') == 85170772
	assert get_static_download_size('invalid') == 0


def test_static_ping_url() -> None:
	assert ping_static_url('https://github.com') is True
	assert ping_static_url('https://hf-mirror.com') is True
...
def test_resolve_download_url_by_provider() -> None:
	...
	assert resolve_download_url_by_provider('huggingface', 'models-3.0.0', 'fairface.onnx') == 'https://hf-mirror.com/facefusion/models-3.0.0/resolve/main/fairface.onnx'
